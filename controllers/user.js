...
exports.removeFromWishlist = async (req, res) => {
  ...
  exports.createCashOrder = async (req, res) => {
    ...
    // if couponApplied is true, create order with status of Cash On Delivery
    ...
    if (couponApplied && userCart.totalAfterDiscount) {
       finalAmount = Math.floor(userCart.totalAfterDiscount * 100)
    } else {
       finalAmount = Math.floor(userCart.cartTotal * 100 )
    }
